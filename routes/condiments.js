...
const collectionName = 'condiments';
...
router.get('/:condimentId', function (req, res) {
    var o_id = new mongo.ObjectID(req.params.condimentId);
...
router.delete('/:condimentId', function (req, res) {
    var o_id = new mongo.ObjectID(req.params.condimentId);
